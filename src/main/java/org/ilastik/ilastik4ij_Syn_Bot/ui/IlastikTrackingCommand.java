...
import org.ilastik.ilastik4ij_Syn_Bot.executors.Tracking;
...
@Plugin(type = Command.class, headless = true, menuPath = "Plugins>ilastik_Syn_Bot>Run Tracking for Syn_Bot")
